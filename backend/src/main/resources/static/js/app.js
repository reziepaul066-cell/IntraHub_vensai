...
function renderDepartments(depts) {
  ...
  grid.innerHTML = depts.map(d => `
    <div class="fluent-card">
      ...
      <div style="font-size: 12px; color: var(--teams-purple-hover); margin-bottom: 12px;">
...
function renderEmployees(list) {
  ...
  tbody.innerHTML = list.map(emp => `
    <tr>
      <td><span style="font-family: monospace; font-weight: 700; color: var(--teams-purple-hover);">${emp.employeeCode || 'EMP-00' + emp.id}</span></td>
      <td>
